                    ...
                    <div class="details" style="border: 1px solid #B7B7B7;padding: 10px;" >
                        ...
                        <div class="tab-content">
                            ...
                            <div id="doc" class="tab-pane fade">
                                ...
                                <a href="<?php echo e(url($type.'/2/viewform')); ?>" class="btn btn-success"><?php echo e(trans('Add a Document to this event')); ?></a>
                                </div>
                            <h3>Documents</h3>
                                <hr>
                                <table border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(url($type.'/5/eventpdf')); ?>" class="btn btn-success"><?php echo e(trans('View')); ?></a></td>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="msg" class="tab-pane fade">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group required <?php echo e($errors->has('msg') ? 'has-error' : ''); ?>">
                                                                    <?php echo Form::label('', null, ['class' => 'control-label ']); ?>

                                                                    <div class="controls">
                                                                        <?php echo Form::textarea('msg', null, ['class' => 'form-control','id'=> 'docu']); ?>
                                ...
                                <div class="modal fade" id="x" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?php echo Form::open(['url' => $type, 'method' => 'post', 'files'=> true,'id'=>'a1']); ?>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapse1" class="panel-collapse collapse">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div align="right" ><a href="#" class="btn btn-success"><?php echo e(trans('Use Email Editor')); ?></a></div>
                                                <h3>Recipients</h3>
                                                <hr cl col-md-4>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group required <?php echo e($errors->has('task_desc') ? 'has-error' : ''); ?>">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo Form::textarea('task_desc', null, ['class' => 'form-control']); ?>
                                                ...
                                                <div class="form-group <?php echo e($errors->has('associated_to') ? 'has-error' : ''); ?>">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo Form::select('associated_to', isset($lead)?$states:[0=>trans('Associated to')], null, ['id'=>'state_id', 'class' => 'form-control']); ?>

                                                        <span class="help-block"><?php echo e($errors->first('associated_to', ':message')); ?></span>
                                                    </div>
                                                </div>
                                                <div class="form-group <?php echo e($errors->has('assigness') ? 'has-error' : ''); ?>">
                                                    <?php echo Form::label('assigness', trans('Assigness'), ['class' => 'control-label required']); ?>

                                                    <div class="controls">
                                                        <?php echo Form::select('associated_to', isset($lead)?$states:[0=>trans('Document Id')], null, ['id'=>'state_id', 'class' => 'form-control']); ?>

                                                        <span class="help-block"><?php echo e($errors->first('assigness', ':message')); ?></span>
                                                    </div>
                                                </div>
                                                <div class="form-group required <?php echo e($errors->has('due_date') ? 'has-error' : ''); ?>">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo Form::date('due_date', null, ['class' => 'form-control']); ?>
                                                ...
                                                <div class="form-group <?php echo e($errors->has('priority') ? 'has-error' : ''); ?>">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo Form::select('priority', isset($lead)?$states:[0=>trans('Priority')], null, ['id'=>'state_id', 'class' => 'form-control']); ?>
                                            ...
                                            <div class="modal-footer">
                                               <span><a href="<?php echo e(url($type.'/2/show')); ?>" class="btn btn-success" data-dismiss="modal"><?php echo e(trans('CANCLE')); ?></a></span>
                                               <span> <a href="<?php echo e(url($type.'/2/show')); ?>" class="btn btn-success" data-dismiss="modal"><?php echo e(trans('SAVE')); ?></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal fade" id="myModal" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="<?php echo e(url($type.'/2/show')); ?>" class="btn btn-success" data-dismiss="modal"><i class="fa fa-arrow-left"> <?php echo e(trans('BACK')); ?></i></a></span>
                                                <span> <a href="<?php echo e(url($type.'/2/show')); ?>" class="btn btn-success" data-dismiss="modal"><?php echo e(trans('SAVE')); ?></a></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group <?php echo e($errors->has('amount') ? 'has-error' : ''); ?>">
                                                    ...
                                                    <div class="controls">
                                                        <?php echo Form::select('amount', isset($lead)?$states:[0=>trans('-- Custom Amount --')], null, ['id'=>'state_id', 'class' => 'form-control']); ?>
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="form-group <?php echo e($errors->has('doc_id') ? 'has-error' : ''); ?>">
                                                        ...
                                                        <div class="controls">
                                                            <?php echo Form::select('doc_id', isset($lead)?$states:[0=>trans('-- Document Id --')], null, ['id'=>'state_id', 'class' => 'form-control']); ?>
                                                    ...
                                                    <div class="form-group required <?php echo e($errors->has('date') ? 'has-error' : ''); ?>">
                                                        <?php echo Form::label('date', trans('Deadline'), ['class' => 'control-label required']); ?>
                                                ...
                                                <div class="form-group required <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
                                                    <?php echo Form::label('title', trans('Customer-facing Title'), ['class' => 'control-label required']); ?>
                                                ...
                                                <div class="form-group required <?php echo e($errors->has('note') ? 'has-error' : ''); ?>">
                                                    <?php echo Form::label('note', trans('Internal Note'), ['class' => 'control-label required']); ?>
