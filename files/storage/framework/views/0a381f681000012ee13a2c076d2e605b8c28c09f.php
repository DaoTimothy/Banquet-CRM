            ...
            <div id="eating_times" class="<?php echo e($errors->has('service_time') || $errors->has('canapes') ? '' : 'collapse multi-collapse'); ?> form-panel-collapse">
                <div class="event_collapse_padding">
                    ...
                    <div class="row">
                        ...
                        <?php
                        if (isset($event)) {
                            $mrt = ($event->eating_times->morning_tea_time == NULL) ? '' : array($event->eating_times->morning_tea_time, $event->eating_times->morning_tea_time_end);
                        }
                        ?>
                    ...
                    <div class="row">
                        ...
                        <?php
                        if (isset($event)) {
                            $evt = ($event->eating_times->evening_tea_time == NULL) ? '' : array($event->eating_times->evening_tea_time, $event->eating_times->evening_tea_time_end);
                        }
                        ?>
                    ...
                    <?php
                    if (isset($event)) {
                        $evs = ($event->eating_times->evening_snacks_time == NULL) ? '' : array($event->eating_times->evening_snacks_time, $event->eating_times->evening_snacks_time_end);
                    }
                    ?>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <?php
                        if (isset($event)) {
                            $dt = ($event->eating_times->dinner_time == NULL ? '' : array($event->eating_times->dinner_time, $event->eating_times->dinner_time_end));
                        }
                        ?>
                        <div class="col-md-3">
                            <div class="form-group required <?php echo e($errors->has('dinner_start_time') ? 'has-error' : ''); ?>">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><?php echo e(trans('event.from')); ?></span>
                                    <?php echo Form::text('dinner_start_time', (isset($dt) ? (is_array($dt) ? $dt[0] : '') :null), ['class' => 'form-control',"id"=>"dinner_start_time","placeholder"=>"Select Dinner Start Time"]); ?>
                        ...
                        <div class="col-md-3 end_field">
                            <div class="form-group required <?php echo e($errors->has('dinner_end_time') ? 'has-error' : ''); ?>">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><?php echo e(trans('event.to')); ?></span>
                                    <?php echo Form::text('dinner_end_time', (isset($dt) ? (is_array($dt) ? $dt[1] : '') :null), ['class' => 'form-control',"id"=>"dinner_end_time","placeholder"=>"Select Dinner End Time"]); ?>
