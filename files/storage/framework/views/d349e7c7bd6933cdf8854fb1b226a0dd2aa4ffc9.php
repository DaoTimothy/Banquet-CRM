...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($user_data->inRole('admin')): ?>
        <fieldset>
            ...
            <ul>
                <?php $__currentLoopData = $company->revisionHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><?php echo e($history->userResponsible()->first_name); ?> changed <?php echo e($history->fieldName()); ?>

                    from <?php echo e($history->old_value); ?> to <?php echo e($history->new_value); ?></li>
