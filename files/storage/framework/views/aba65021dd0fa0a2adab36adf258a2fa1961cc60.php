<div class="panel panel-primary">
    <div class="panel-body">
        <?php if(isset($saleorder)): ?>
            <?php echo Form::open(['url' => $type . '/' . $saleorder->id, 'method' => 'delete', 'class' => 'bf']); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="controls">
                            ...
                            <?php else: ?>
                                <button type="submit" class="btn btn-success"><i class="fa fa-undo"></i> <?php echo e(trans('table.restore')); ?>
