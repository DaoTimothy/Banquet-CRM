        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-8 col-lg-9">
                <div class="form-group">
                    ...
                    : <?php echo e($customer->title.''.$customer->user->full_name); ?>
                ...
                <div class="form-group">
                    <?php echo Form::label('phone', trans('customer.phone'), ['class' => 'control-label']); ?>

                    : <?php echo e($customer->user->phone_number); ?>
        ...
        <div class="row">
            <div class="col-sm-4 col-lg-3">
                <div class="form-group">
                    ...
                    <div>
                        <?php echo e($customer->job_position); ?>
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="form-group">
                    ...
                    <div>
                        <?php echo e((isset($customer))?$customer->company->name:null); ?>
            ...
            <div class="col-sm-4 col-lg-3">
                <div class="form-group">
                    ...
                    <div>
                        <?php echo e($customer->salesTeam->salesteam); ?>
