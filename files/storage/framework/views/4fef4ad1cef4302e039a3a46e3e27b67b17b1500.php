...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($user_data->inRole('admin')): ?>
        <fieldset>
            ...
            <ul>
                <?php $__currentLoopData = $product->revisionHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
