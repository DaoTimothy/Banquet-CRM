...
<table class="table table-bordered table-border">
    ...
    <table>
        ...
        <tr>
            <td>
                <h5>This is entertainment contract is entered into as of <b><?php echo e(date('D d,Y',strtotime($event->booking->from_date))); ?></b> by and between <b><?php echo e($event->owner_trashed->name); ?></b>,the
            ...
            <td class="pdf-box-content">
                <table class="table table-bordered table-border">
                    ...
                    <tr>
                        ...
                        <td class="table-border td-padding"><?php echo e($event->name); ?></td>
                    </tr>
                    <tr>
