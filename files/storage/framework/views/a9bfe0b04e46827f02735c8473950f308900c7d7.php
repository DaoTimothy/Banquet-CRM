        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group required <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
                    ...
                    <div class="controls">
                        <?php echo Form::text('name', (isset($data) ? $data->type : null), ['class' => 'form-control','id'=>'name']); ?>
            ...
            <div class="col-md-6">
                <div class="form-group required <?php echo e($errors->has('service_provided') ? 'has-error' : ''); ?>" id="service_div">
                    ...
                    <div class="controls">
                        <?php echo Form::text('service_provided', (isset($data) ? $data->capacity : null), ['class' => 'form-control','id'=>'service']); ?>
