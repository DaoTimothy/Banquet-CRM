...
<?php $__env->startSection('content'); ?>
    <div class="panel panel-default m-t-30">
        ...
        <div class="panel-body">
            ...
            <a href="<?php echo e(url('quotation')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> <?php echo e(trans('table.back')); ?></a>
        </div>
    </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(document).ready(function () {
            window.oTable.ajax.url('<?php echo url($type.'/draft_quotations_list'); ?>');
