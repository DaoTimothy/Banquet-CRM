    ...
    <div class="page-header clearfix">
        <?php if($user_data->hasAccess(['logged_calls.write']) || $user_data->inRole('admin')): ?>
            <div class="pull-right">
                <a href="<?php echo e(url($type.'/'.$lead->id.'/create')); ?>" class="btn btn-primary call-summary">
                    <i class="fa fa-plus-circle"></i> <?php echo e(trans('lead.call')); ?></a>
            </div>
        <?php endif; ?>
    </div>
    <input type="hidden" id="id" value="<?php echo e($lead->id); ?>">
            ...
            <div class="table-responsive">
                <table id="data" class="table table-bordered" data-id="data">
                    ...
                    <tr>
                        ...
                        <th width="40%"><?php echo e(trans('call.summary')); ?></th>
