                ...
                <table class="table table-bordered" id="menuTable">
                    ...
                    <?php if(count($menus) > 0): ?>
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($menu->sub_menu->main_menu->name); ?></td>
                                <td><?php echo e($menu->sub_menu->menu_type_data->name); ?></td>
                                <td><?php echo e($menu->sub_menu->name); ?></td>
                                <td><?php echo e($menu->name); ?></td>
                                <td><?php echo e($menu->price); ?></td>
                                <td><a href="<?php echo e(url('eventMenu/' . $menu->id . '/editMenuItem' )); ?>" title="<?php echo e(trans('table.edit')); ?>">
                                        <i class="fa fa-fw fa-pencil text-warning"></i> </a>
                                    <a href="<?php echo e(url('eventMenu/' . $menu->id . '/deleteMenuItem' )); ?>" title="<?php echo e(trans('table.delete')); ?>">
