            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group required <?php echo e($errors->has('price') ? 'has-error' : ''); ?>" id="service_div">
                        ...
                        <div class="controls">
                            <?php echo Form::number('price', (isset($data) ? $data->price : null), ['class' => 'form-control','min' => 0, 'placeholder'=>'Enter amount in '.\Config::get('constant.currency.'.Settings::get('currency'))[0]]); ?>
