...
<table class="table table-bordered table-border">
    ...
    <table>
        ...
        <tr>
            <td>
                <h5>This is entertainment contract is entered into as of <b><?php echo e(date('D d,Y',strtotime($event->booking->from_date))); ?></b> by and between <b><?php echo e($event->owner_trashed->first_name); ?> <?php echo e($event->owner_trashed->last_name); ?></b>,the
