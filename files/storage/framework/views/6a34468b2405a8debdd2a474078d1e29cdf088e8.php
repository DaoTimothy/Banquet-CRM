<div class="panel panel-primary">
    <div class="panel-body">
        ...
        <?php endif; ?>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::select('title', $titles, (isset($user))?$user->customer->title:null, ['id'=>'title', 'class' => 'form-control select2']); ?>
                ...
                <div class="col-md-5">
                    <div class="form-group <?php echo e($errors->has('first_name') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::text('first_name', isset($customer)?$customer->user->first_name:null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-5">
                    <div class="form-group <?php echo e($errors->has('last_name') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::text('last_name', isset($customer)?$customer->user->last_name:null, ['class' => 'form-control']); ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('job_position') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::text('job_position', (isset($user))?$user->customer->job_position:null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('company_id') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::select('company_id', $companies, (isset($user))?$user->customer->company_id:null, ['id'=>'company_id', 'class' => 'form-control select2']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('sales_team_id') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::select('sales_team_id', $salesteams, (isset($user))?$user->customer->sales_team_id:null, ['id'=>'sales_team_id', 'class' => 'form-control select2']); ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('email') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::email('email', isset($customer)?$customer->user->email:null, ['class' => 'form-control']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('phone_number') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::text('phone_number', isset($customer)?$customer->user->phone_number:null, ['class' => 'form-control ','data-fv-integer' => 'true']); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group <?php echo e($errors->has('mobile') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::text('mobile', (isset($user))?$user->customer->mobile:null, ['class' => 'form-control','data-fv-integer' => 'true']); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group <?php echo e($errors->has('address') ? 'has-error' : ''); ?>">
                        ...
                        <div class="controls">
                            <?php echo Form::textarea('address', (isset($user))?$user->customer->address:null, ['class' => 'form-control resize_vertical']); ?>
            ...
            <?php if(!Request::is('customer/*/edit')): ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group <?php echo e($errors->has('password') ? 'has-error' : ''); ?>">
                            <?php echo Form::label('password', trans('customer.password'), ['class' => 'control-label required']); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group <?php echo e($errors->has('password_confirmation') ? 'has-error' : ''); ?>">
                            <?php echo Form::label('password_confirmation', trans('customer.password_confirmation'), ['class' => 'control-label required']); ?>
