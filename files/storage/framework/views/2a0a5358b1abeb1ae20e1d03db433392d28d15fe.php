    ...
    <div class="page-header clearfix">
        <?php if($user_data->hasAccess(['eventSettings.write']) || $user_data->inRole('admin')): ?>
            <div class="pull-right">
                ...
                <a href="<?php echo e(url($type.'/equipCreate')); ?>" class="btn btn-primary">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead>
                    <tr>
                        <th><?php echo e(trans('eventSetting.service')); ?></th>
                    ...
                    <?php if(count($data) > 0): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('eventSetting/'. $value->id . '/equipEdit' )); ?>" title="<?php echo e(trans('table.edit')); ?>">
                                        <i class="fa fa-fw fa-pencil text-warning"></i> </a>
                                    <a href="<?php echo e(url('eventSetting/' . $value->id . '/equipDelete' )); ?>" title="<?php echo e(trans('table.delete')); ?>">
