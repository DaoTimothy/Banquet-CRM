    ...
    <div class="page-header clearfix">
        <?php if($user_data->hasAccess(['eventSettings.write']) || $user_data->inRole('admin')): ?>
            <div class="pull-right">
                ...
                <a href="<?php echo e(url($type.'/entertainCreate')); ?>" class="btn btn-primary">
                    ...
                    <?php if(count($data) > 0): ?>
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('eventSetting/'. $value->id . '/entertainEdit' )); ?>" title="<?php echo e(trans('table.edit')); ?>">
                                    <i class="fa fa-fw fa-pencil text-warning"></i> </a>
                                    <a href="<?php echo e(url('eventSetting/' . $value->id . '/entertainDelete' )); ?>" title="$value->id<?php echo e(trans('table.delete')); ?>">
