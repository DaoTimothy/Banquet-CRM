...
class MeetingController extends UserController
{
    ...
    public function show(Meeting $meeting)
    {
        ...
        $user = new User();
        return view('user.meeting.show', compact('title', 'meeting', 'action','user'));
    }
    ...
    public function data(Datatables $datatables)
    {
        ...
        return $datatables->collection($meetings)
            ->addColumn('actions', ' @if(Sentinel::getUser()->hasAccess([\'meetings.write\']) || Sentinel::inRole(\'admin\'))
                                     ...
                                     @endif
                                     @if(Sentinel::getUser()->hasAccess([\'meetings.read\']) || Sentinel::inRole(\'admin\'))
                                        <a href="{{ url(\'meeting/\' . $id . \'/show\' ) }}" title="{{ trans(\'table.view\') }}">
                                            <i class="fa fa-fw fa-eye text-danger"></i> </a>    
                                     @endif
